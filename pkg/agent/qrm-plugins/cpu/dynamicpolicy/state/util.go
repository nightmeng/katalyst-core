...
func GetNonBindingSharedRequestedQuantityFromPodEntries(podEntries PodEntries, newNonBindingSharedRequestedQuantity []float64, ignorePods sets.String, getContainerRequestedCores GetContainerRequestedCoresFunc) int {
	...
	for podUid, entries := range podEntries {
		...
		if ignorePods != nil && ignorePods.Has(podUid) {
			continue
		}
